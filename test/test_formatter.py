...
class FormatLabeledField(unittest.TestCase):
    def test_labels_are_selected_alphabetically_if_no_preferred_given(self):
        ...
        self.assertEqual(
            expected, Formatter.format_labeled_field(labeled_field, preferred)
        )
...
class GetSpecialField(unittest.TestCase):
    ...
    _vcard = CarddavObject(
        vCard(fn="Formatted Name", n=_name, nickname="Nickname"),
    ...
    def test_name_formatted_as_first_name_last_name(self):
        self._test_name(Formatter.FIRST, False, False, "Given Additional Family")

    def test_name_formatted_as_first_name_last_name_with_nickname(self):
        self._test_name(
            Formatter.FIRST, True, False, "Given Additional Family (Nickname: Nickname)"
        )

    def test_name_formatted_as_last_name_first_name(self):
        self._test_name(Formatter.LAST, False, False, "Family, Given Additional")

    def test_name_formatted_as_last_name_first_name_with_nickname(self):
        self._test_name(
            Formatter.LAST, True, False, "Family, Given Additional (Nickname: Nickname)"
        )
    ...
    def test_name_formatted_as_formatted_name_with_nickname(self):
        self._test_name(
            Formatter.FORMAT, True, False, "Formatted Name (Nickname: Nickname)"
        )
