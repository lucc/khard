...
class VcardAddressBookLoad(unittest.TestCase):
    def test_vcards_without_uid_generate_a_warning(self):
        abook = address_book.VdirAddressBook("test", "test/fixture/minimal.abook")
        with self.assertLogs(level="WARNING") as cm:
            abook.load()
            messages = [
                "WARNING:khard.address_book:Card minimal contact from "
    ...
    def test_loading_unparsable_vcard_fails(self):
        abook = address_book.VdirAddressBook("test", "test/fixture/broken.abook")
...
class AddressBookGetShortUidDict(unittest.TestCase):
    def test_unique_uid_also_reslts_in_shortened_uid_in_short_uid_dict(self):
